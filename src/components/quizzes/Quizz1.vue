<template>
    <img src="/miguro_2.webp" alt="" style="width: 50%;">
    ...
    <v-dialog v-model="dialog" max-width="500">
        <v-card :title="title">
            ...
            <v-card-text class="text-center">
                ...
                <v-text-field label="Please type your answer.." class="mt-5" @keyup="showSubmitBtn" v-model="userAnswer"
                    :disabled="showAnswer" />
