        ...
        <v-row>
            <v-col cols="12" md="12" sm="12" >
                ...
                <v-col cols="12" md="8" sm="12" v-for="(data, index) in accordion">
                    ...
                    <v-list-item class="mx-6" v-for="(example, index) in data.example"><b>{{ example.kana }}</b><br />Romaji: {{ example.romaji }}<br />Translation: {{ example.translation
                        }}</v-list-item>
                </v-col>
                <v-col cols="12" md="10" sm="12">
...
const accordion = [
    {
       title: '1. "Ga" as a Subject Marker', paragraph: 'In Japanese, the subject of a sentence is often marked by the particle "が" (ga). This helps clarify who or what is performing the action in the sentence. While English often uses word order to determine the subject, Japanese relies more on particles like "が."',
        example: [
            {
    ...
    {
        title: '2. "Ga" to Indicate Emphasis or Specificity', paragraph: 'The "ga" particle can also be used to emphasize or specify a particular subject within a larger context. This is often seen when a sentence contrasts or highlights one thing over another.',
        example: [
            {
    ...
    {
        title: '3. "Ga" in Sentences with "Arimasu" or "Imasu"', paragraph: 'In certain sentences where the verb "ある (aru)" or "いる (iru)" is used (to exist for inanimate or animate objects, respectively), the "ga" particle is commonly used to mark the subject.',
        example: [
            {
    ...
    {
        title: '4. "Ga" in Questions (When Using "Dare" or "Nani")', paragraph: 'The "ga" particle is also used in questions, especially when asking about specific subjects or things.',
        example: [
            {
